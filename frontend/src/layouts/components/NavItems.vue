...
<template>
  ...
  <VerticalNavSectionTitle
    :item="{
      heading: t('menu.scanTools'),
    }"
  />
  <VerticalNavLink
    :item="{
      title: t('menu.mediaScan'),
      icon: 'ri-radar-line',
      to: '/media-scan',
    }"
  />
